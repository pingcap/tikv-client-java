...
class MyDecimal {
    ...
    private final static int wordBufLen = 9;
    // A word is 4 bytes int
    private final static int wordSize = 4;
    private final static int ten0 = 1;
    private final static int ten1 = 10;
    private final static int ten2 = 100;
    private final static int ten3 = 1000;
    private final static int ten4 = 10000;
    private final static int ten5 = 100000;
    private final static int ten6 = 1000000;
    private final static int ten7 = 10000000;
    private final static int ten8 = 100000000;
    private final static int ten9 = 1000000000;
    private final static int digMask = ten8;
    private final static int wordBase = ten9;
    private final static int wordMax  = wordBase - 1;
    private final static int[] powers10 = new int[]{ten0, ten1, ten2, ten3, ten4, ten5, ten6, ten7, ten8, ten9};

    // A MyDecimal holds 9 words.
    private final static int maxWordBufLen = 9;
    private final static int maxFraction = 30;
    private final static int[] dig2bytes  = new int[]{0, 1, 1, 2, 2, 3, 3, 4, 4, 4};
    ...
    */
    public int precision() {
        ...
        int digitsInt = this.removeLeadingZeros()[1]; /*this function return an array and the second element is digitsInt*/
