...
public class TiTime extends Date {
    public static SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    public static SimpleDateFormat fspDataFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");

    public static final Duration minTime = Duration.standardSeconds(-838*3600+59*60+59);
    public static final Duration maxTime = Duration.standardSeconds(838*3600+59*60+59);
    public static final String zeroDateTimeStr = "0000-00-00 00:00:00";
    public static final String zeroDataStr = "0000-00-00";

    public Time fromData(int year, int month, int day, int hour, int minute, int second, int microsecond) {
        Date date = new Date();
        return null;
    }
