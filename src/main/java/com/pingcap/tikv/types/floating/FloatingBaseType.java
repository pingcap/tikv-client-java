 ...
 */
public abstract class FloatingBaseType<T> extends FieldType<T> {
    protected FloatingBaseType(TiColumnInfo.InternalTypeHolder holder) {
        super(holder);
    }
    protected FloatingBaseType() {}
