...
public class DataTypeFactory {
    ...
    private static final Map<Integer, DataType> dataTypeMap = ImmutableMap.<Integer, DataType>builder()
            ...
            .put(TYPE_VARCHAR, StringType.of(TYPE_VARCHAR))
            .put(TYPE_JSON, StringType.of(TYPE_JSON))
            .put(TYPE_ENUM, StringType.of(TYPE_ENUM))
            .put(TYPE_SET, StringType.of(TYPE_SET))
            .put(TYPE_TINY_BLOB, StringType.of(TYPE_TINY_BLOB))
            .put(TYPE_MEDIUM_BLOB, StringType.of(TYPE_MEDIUM_BLOB))
            .put(TYPE_LONG_BLOB, StringType.of(TYPE_LONG_BLOB))
            .put(TYPE_BLOB, StringType.of(TYPE_BLOB))
            .put(TYPE_VAR_STRING, StringType.of(TYPE_VAR_STRING))
            .put(TYPE_STRING, StringType.of(TYPE_STRING))
            .put(TYPE_GEOMETRY, StringType.of(TYPE_GEOMETRY))
            .build();
