...
public class RegionStoreClient extends AbstractGrpcClient<TikvBlockingStub, TikvStub> {
    ...
    public ByteString get(ByteString key, long version) {
        GetRequest request = GetRequest.newBuilder()
                ...
                .setVersion(version)
                .build();
        KVErrorHandler<GetResponse> handler = new KVErrorHandler<>();
        handler.bind(GetResponse::getRegionError);
    ...
    public void rawPut(ByteString key, ByteString value,Context context) {
        ...
        KVErrorHandler<RawPutResponse> handler = new KVErrorHandler<>();
        handler.bind(RawPutResponse::getRegionError);
    ...
    public ByteString rawGet(ByteString key,Context context){
        RawGetRequest rawGetRequest = RawGetRequest.newBuilder()
                ...
                .setKey(key)
                .build();
        KVErrorHandler<RawGetResponse> handler = new KVErrorHandler<>();
        handler.bind(RawGetResponse::getRegionError);
    ...
    public void rawDelete(ByteString key,Context context){
        ...
        KVErrorHandler<RawDeleteResponse> handler = new KVErrorHandler<>();
        handler.bind(RawDeleteResponse::getRegionError);
    ...
    public List<KvPair> batchGet(Iterable<ByteString> keys, long version) {
        BatchGetRequest request = BatchGetRequest.newBuilder()
                ...
                .setVersion(version)
                .build();
        KVErrorHandler<BatchGetResponse> handler = new KVErrorHandler<>();
        handler.bind(BatchGetResponse::getRegionError);
    ...
    public List<KvPair> scan(ByteString startKey, long version, boolean keyOnly) {
        ScanRequest request = ScanRequest.newBuilder()
                ...
                .build();
        KVErrorHandler<ScanResponse> handler = new KVErrorHandler<>();
        handler.bind(ScanResponse::getRegionError);
    ...
    public SelectResponse coprocess(SelectRequest req, List<KeyRange> ranges) {
        Coprocessor.Request reqToSend = Coprocessor.Request.newBuilder()
                ...
                .addAllRanges(ranges)
                .build();
        KVErrorHandler<Coprocessor.Response> handler = new KVErrorHandler<>();
        handler.bind(Coprocessor.Response::getRegionError);
