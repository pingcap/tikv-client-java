...
public class RegionStoreClient extends AbstractGrpcClient<TikvBlockingStub, TikvStub> {
    ...
    public ByteString get(ByteString key, long version) {
        GetRequest request = GetRequest.newBuilder()
                ...
                .setVersion(version)
                .build();
        GetResponse resp = callWithRetry(TikvGrpc.METHOD_KV_GET, request, GetResponse::getRegionError);
    ...
    public void rawPut(ByteString key, ByteString value,Context context) {
        ...
        RawPutResponse resp = callWithRetry(TikvGrpc.METHOD_RAW_PUT, rawPutRequest, RawPutResponse::getRegionError);
    ...
    public ByteString rawGet(ByteString key,Context context){
        RawGetRequest rawGetRequest = RawGetRequest.newBuilder()
                ...
                .setKey(key)
                .build();
        RawGetResponse resp = callWithRetry(TikvGrpc.METHOD_RAW_GET, rawGetRequest, RawGetResponse::getRegionError);
    ...
    public void rawDelete(ByteString key,Context context){
        ...
        RawDeleteResponse resp = callWithRetry(TikvGrpc.METHOD_RAW_DELETE, rawDeleteRequest,  RawDeleteResponse::getRegionError);
        if (resp.hasRegionError()) {
            throw new RegionException(resp.getRegionError());
        }
    }
    ...
    public Future<ByteString> getAsync(ByteString key, long version) {
        ...
        callAsyncWithRetry(TikvGrpc.METHOD_KV_GET, request, responseObserver, GetResponse::getRegionError);
    ...
    public List<KvPair> batchGet(Iterable<ByteString> keys, long version) {
        BatchGetRequest request = BatchGetRequest.newBuilder()
                ...
                .setVersion(version)
                .build();
        BatchGetResponse resp = callWithRetry(TikvGrpc.METHOD_KV_BATCH_GET, request, BatchGetResponse::getRegionError);
    ...
    public Future<List<KvPair>> batchGetAsync(Iterable<ByteString> keys, long version) {
        ...
        callAsyncWithRetry(TikvGrpc.METHOD_KV_BATCH_GET, request, responseObserver, BatchGetResponse::getRegionError);
        return responseObserver.getFuture();
    }
    ...
    public List<KvPair> scan(ByteString startKey, long version, boolean keyOnly) {
        ScanRequest request = ScanRequest.newBuilder()
                ...
                .build();
        ScanResponse resp = callWithRetry(TikvGrpc.METHOD_KV_SCAN, request, ScanResponse::getRegionError);
    ...
    public Future<List<KvPair>> scanAsync(ByteString startKey, long version, boolean keyOnly) {
        ...
        callAsyncWithRetry(TikvGrpc.METHOD_KV_SCAN, request, responseObserver, ScanResponse::getRegionError);
        return responseObserver.getFuture();
    }
    ...
    public SelectResponse coprocess(SelectRequest req, List<KeyRange> ranges) {
        Coprocessor.Request reqToSend = Coprocessor.Request.newBuilder()
                ...
                .addAllRanges(ranges)
                .build();
        Coprocessor.Response resp = callWithRetry(TikvGrpc.METHOD_COPROCESSOR, reqToSend, Coprocessor.Response::getRegionError);
    ...
    public Future<SelectResponse> coprocessAsync(SelectRequest req, List<KeyRange> ranges) {
        ...
        Coprocessor.Request reqToSend = Coprocessor.Request.newBuilder()
                ...
                .addAllRanges(ranges)
                .build();
        callAsyncWithRetry(TikvGrpc.METHOD_COPROCESSOR, reqToSend, responseObserver, Coprocessor.Response::getRegionError);
        return responseObserver.getFuture();
    }
