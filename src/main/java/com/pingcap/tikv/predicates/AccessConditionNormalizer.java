...
public class AccessConditionNormalizer {
        ...
        if (expr instanceof TiFunctionExpression) {
            ...
            if (func instanceof GreaterThan ||
                ...
                if ((func.getArg(0) instanceof TiColumnRef &&
                        func.getArg(1) instanceof TiConstant)
                        ||
                        (func.getArg(1) instanceof TiColumnRef &&
                                func.getArg(0) instanceof TiConstant)) {
                    return true;
                }
            }
    ...
    public static class NormalizedCondition {
        ...
        public NormalizedCondition(TiColumnRef columnRef,
                                   List<TiConstant> constantVals,
                                   TiFunctionExpression condition) {
    ...
    public static NormalizedCondition normalize(TiExpr expr) {
        ...
        if (expr instanceof TiFunctionExpression) {
            ...
            if (func instanceof In) {
                ...
                return new NormalizedCondition((TiColumnRef) func.getArg(0),
                        ImmutableList.of((TiConstant) func.getArg(1)),
                        func);
            }
        }
        throw new TiClientInternalException("Not a valid access condition expression: " + expr);
