...
public class RangeBuilderTest {
    ...
    public void exprToRanges() throws Exception {
        ...
        List<TiExpr> conds = ImmutableList.of(
                ...
                new GreaterThan(TiConstant.create(100L), TiColumnRef.create("c1", table)), // 100 > c1 -> c1 < 100
        ...
        List<TiExpr> ac = ImmutableList.of(
                new In(TiColumnRef.create("c1", table),
                        TiConstant.create(0L),
        ...
        assertTrue(testPointIndexRanges(indexRanges,
                Lists.newArrayList(
                        ImmutableList.of(0L, "v1"),
                        ImmutableList.of(1L, "v1")
                )
        ));

        conds = ImmutableList.of(
                new GreaterEqual(TiColumnRef.create("c3", table), TiConstant.create("a")), // c1 >= 0
                new GreaterThan(TiConstant.create("z"), TiColumnRef.create("c3", table)), // 100 > c1 -> c1 < 100
