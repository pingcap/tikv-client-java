...
public class GrpcUtils {
    public static ResponseHeader makeDefaultHeader(long clusterId) {
    ...
    public static Member makeMember(long memberId, String ...urls) {
        return Member.newBuilder()
                ...
                .addAllClientUrls(Arrays.asList(urls))
                .build();
    }
