...
public class TiSelectRequestTest {
    ...
    public void testSerializable() throws Exception {
        ...
        selReq.addField(TiColumnRef.create("c1", table))
                ...
                .addGroupByItem(TiByItem.create(new Divide(TiColumnRef.create("c2", table), TiConstant.create(100L)), true))
                .addOrderByItem(TiByItem.create(new Minus(TiColumnRef.create("c2", table), TiConstant.create(999)), false))
                .setTableInfo(table)
                .setStartTs(666)
    ...
    public static boolean selectRequestEquals(TiSelectRequest lhs, TiSelectRequest rhs) {
        ...
        assertEquals(lhs.getIndexInfo().toProto(lhs.getTableInfo()),
